	...
	<div class="row">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
		  <div class="form-group">
			...
			-->
			{{Form::number('phone', null, array('class' => 'form-control','placeholder'=>"Mobile"))}}
		  </div>
		</div>
		...
		<div class="row" >
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				...
				<!--<input type="email" class="form-control" id="" placeholder="Company Type">
			  	-->
			  	{{Form::text('company_type', null, array('class' => 'form-control','placeholder'=>"Company Type"))}}
			  </div>
			</div>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				...
				{{Form::text('date_of_incorporation', null, array('class' => 'form-control datepicker','placeholder'=>"Founded On"))}}
			  </div>
			</div>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				...
				{{Form::text('company_pan', null, array('class' => 'form-control','placeholder'=>"PAN"))}}
			  </div>
			</div>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				...
				{{Form::text('name_of_authority', null, array('class' => 'form-control','placeholder'=>"Authority Name"))}}
			  </div>
			</div>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				...
				{{Form::number('iata_no', null, array('class' => 'form-control','placeholder'=>"IATA Number"))}}
			  </div>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				...
				{{Form::text('valid_from', null, array('class' => 'form-control datepicker','placeholder'=>"Valid From (Document)"))}}
			  </div>
			</div>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				...
				{{Form::text('valid_till', null, array('class' => 'form-control datepicker','placeholder'=>"Valid Till (Document)"))}}
			  </div>
			</div>
		...
		<div class="add-more row">
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				...
				<!-- <input type="email" class="form-control" id="" placeholder="Founded On"> -->
				{{Form::select('state', array('1' => 'Delhi', '2' => 'Other'),null,array('class' => 'form-control','placeholder'=>"State"))}}
			  </div>
			</div>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				...
				<!-- <input type="email" class="form-control" id="" placeholder="Past Experience"> -->
				{{Form::select('city', array('1' => 'India', '2' => 'Other'),null,array('class' => 'form-control','placeholder'=>"City"))}}
			  </div>
			</div> 
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
			  <div class="form-group">
				<label for="">PIN:</label>
				<!-- <input type="email" class="form-control" id="" placeholder="PAN"> -->
				{{Form::number('pin', null, array('class' => 'form-control','placeholder'=>"PIN"))}}
			  </div>
			</div>
